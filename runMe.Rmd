...
```{r CheckSums}
reproducible::Checksums("modules/Biomass_borealDataPrep//data/",write = T)
reproducible::Checksums("modules/Biomass_core//data/",write = T)
reproducible::Checksums("modules/Biomass_regeneration//data/",write = T)
reproducible::Checksums("modules/caribouRSF//data/",write = T)
  
dirrs <- list.dirs("modules/scfm/modules/",full.names = F,recursive = F)

for(i in dirrs) reproducible::Checksums(paste0("modules/scfm/modules/",i,"/data/"),write = T)
```
